...
export default function Footer() {
  return (
    <div className="flex-col md:items-center md:flex-row flex justify-between px-12 bg-[#F4F4FA] p-[1%]">
      <Link href={"/"}>
        <div>
          <svg
            width="48"
      ...
      <div className="flex font-dm font-bold gap-8">
        <Link href={"/publish"}>
        ...
        <Link href={"/search"}>
          <p className="flex items-center gap-1 cursor-pointer">
            Book A Ride <CiCirclePlus fontWeight={1000} size={20} />
          </p>
        </Link>
      </div>
    </div>
